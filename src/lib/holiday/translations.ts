...
export const HOLIDAY_TRANSLATIONS: Record<HolidayLanguage, HolidayTranslation> = {
    en: {
        ...
        registrationNotice: "Parents & legal guardians may register children age 0-17. Do not register children that are not your legal dependents.",
        ...
        step1Title: "Register",
        step1Desc: "Add your name, phone, and each child (0–17).",
        ...
        guidelineHousehold: "One sign-up per family. Ages 0–17 only.",
        ...
        teenCardEntitlement: "Teen Gift Card(s) (Ages 14–17)",
        ...
        errors: {
            ...
            atLeastOneChild: "Please add at least one child (age 0–17).",
            childNameRequired: "Please enter the child's name.",
            childBirthdateRequired: "Please enter the child's birthdate.",
            childAgeRange: "Age must be between 0 and 17 years old.",
            childOverAge: "{name} is 18 or older and is not eligible. This program is only for children under 18.",
    ...
    es: {
        ...
        registrationNotice: "Los padres y tutores legales pueden inscribir a niños de 0 a 17 años. No registre a niños que no sean sus dependientes legales.",
        ...
        step1Desc: "Agregue su nombre, teléfono y cada niño (0–17).",
        ...
        guidelineHousehold: "Un registro por familia. Edades 0–17.",
        ...
        childSectionSubtitle: "Inscriba a cada hijo o dependiente legal (edades 0–17)",
        ...
        teenCardEntitlement: "Tarjeta(s) de Regalo para Adolescentes (14–17 años)",
        ...
        errors: {
            ...
            atLeastOneChild: "Por favor agregue al menos un niño/a (edad 0–17).",
            ...
            childAgeRange: "La edad debe estar entre 0 y 17 años.",
            childOverAge: "{name} tiene 18 años o más y no es elegible. Este programa es solo para niños menores de 18 años.",
    ...
    zh: {
        ...
        registrationNotice: "父母及法定监护人可为0至17岁的子女进行登记。请勿登记非直系受抚养儿童。",
        ...
        guidelineHousehold: "每个家庭登记一次，仅限0–17岁。",
        cityLabel: "居住城市",
        ...
        childSectionSubtitle: "请添加家庭中所有受抚养的子女（0–17岁）",
        childNameLabel: "儿童姓名",
        childNamePlaceholder: "例：Alexander Zhang",
        childBirthdateLabel: "出生日期",
        childAgeLabel: "年龄 (0–17)",
        ...
        teenCardEntitlement: "青少年礼品卡（14–17岁）",
        ...
        errors: {
            ...
            atLeastOneChild: "请至少添加一名儿童（0–17岁）。",
            childNameRequired: "请输入儿童姓名。",
            childBirthdateRequired: "请输入儿童出生日期。",
            childAgeRange: "儿童年龄须在 0 至 17 岁之间。",
            childOverAge: "{name}已年满18岁，不符合资格。本活动仅限18岁以下儿童参加。",

...
export const CHANGELOG: ChangelogEntry[] = [
    {
        ...
        highlights: [
            {
                type: 'fix',
                title: 'Single-Program Bans No Longer Block Haircut and Holiday',
                description: 'Guests banned from only one program (e.g. showers) can now be signed up for haircuts and holiday services. Those actions are blocked only by a blanket ban covering all programs.',
            },
        ],
    },
    {
    ...
    },
    {
        ...
        highlights: [
            {
                type: 'improvement',
                title: 'Clearer Guest Warning Display',
                description: 'Guest warnings are now color-coded by severity, preview the first message on the collapsed card, and open with one tap on the badge. The expanded panel shows severity, date, and a Manage shortcut, and the Warnings button carries the count.',
            },
        ],
    },
    {
    ...
    },
    {
        ...
        highlights: [
            {
                type: 'fix',
                title: 'Holiday Test-Data Reset Works Again',
                description: 'Clearing test registrations and restarting at Ticket #1 now completes instead of failing. Reset errors also report the real reason now instead of a blank message.',
            },
        ],
    },
    {
    ...
    },
    {
        ...
        highlights: [
            {
                type: 'fix',
                title: 'Linked Guests Stay Visible',
                description: 'Background check-in refreshes now preserve loaded linked guests, warnings, notes, and bicycle descriptions, including when staff are recording meals.',
            },
        ],
    },
    {

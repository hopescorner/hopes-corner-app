 ...
 *
 * Solid silhouette of a person curled up inside a mummy sleeping bag,
 * with the hood opening at the top. Fill-based design inherited from the
 * upstream icon (Kenney/UI sans-serif set); uses `fill="currentColor"` so
 * the parent text color (e.g. `text-purple-600`) controls the icon color,
 * matching the other amenity icons.
 */
export function SleepingBagIcon({ size = 24, className = '', strokeWidth: _strokeWidth = 2 }: SleepingBagIconProps) {
    return (
        <svg
